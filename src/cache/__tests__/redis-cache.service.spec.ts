...
describe('CacheService with Redis', () => {
  ...
  describe('Cache operations', () => {
    it('should set and get a value', async () => {
      ...
      expect(service['cacheManager'].set).toHaveBeenCalledWith(key, value, undefined);
    ...
    it('should delete a value', async () => {
      ...
      // Mock the cache manager methods
      jest.spyOn(service['cacheManager'], 'del').mockImplementation(() => Promise.resolve(true));
    ...
    it('should handle getOrSet correctly', async () => {
      ...
      jest.spyOn(service['cacheManager'], 'set').mockResolvedValueOnce(undefined);
  ...
  describe('Health check', () => {
    ...
    it('should return false when cache is unhealthy', async () => {
      ...
      jest.spyOn(service, 'set').mockRejectedValue(new Error('Connection error'));
