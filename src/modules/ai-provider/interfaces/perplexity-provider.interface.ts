 ...
 */
export interface PerplexityProviderResponse
  extends AIProviderResponse<PerplexityResponseData> {
  metadata: AIProviderResponse<PerplexityResponseData>['metadata'] & {
    /**
